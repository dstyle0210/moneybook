    ...
    return (
        <div className="m-receiptForm -method">
            ...
            <div className="m-receiptForm__inputs">
                <select onChange={(e) => {setReceipt({method:e.target.value})}}>
                    <option value="현금">현금</option>
                    <option value="국민봉올림">국민카드 - 봉올림</option>
                    <option value="국민마올림">국민카드 - 마올림</option>
                    <option value="스마일카드">현대카드 - 스마일</option>
    ...
    return (
        <div className="m-receiptForm -tag">
            ...
            <div className="m-receiptForm__tags">
                <label><input type="radio" name="tag" value="고정" onChange={(e) => {setReceipt({tag:e.target.value})}} /> <span className="a-tag -f">고정</span></label>
                <label><input type="radio" name="tag" value="필수" onChange={(e) => {setReceipt({tag:e.target.value})}} /> <span className="a-tag -r">필수</span></label>
                <label><input type="radio" name="tag" value="변동" onChange={(e) => {setReceipt({tag:e.target.value})}} /> <span className="a-tag -c">변동</span></label>
                <label><input type="radio" name="tag" value="기타" onChange={(e) => {setReceipt({tag:e.target.value})}} /> <span className="a-tag -o">기타</span></label>
            </div>
        </div>
    );
};